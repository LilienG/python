...
def demo_display_specific_digit_combination(images, labels):
    ...
    # Todo: output 2019013293 here——task one
    digit_0 = digit_image_dict[0]
    digit_1 = digit_image_dict[1]
    digit_2 = digit_image_dict[2]
    digit_3 = digit_image_dict[3]
    digit_9 = digit_image_dict[9]
    target_img = torch.cat((digit_2, digit_0, digit_1, digit_9, digit_0, digit_1, digit_3, digit_2, digit_9, digit_3), 2)
